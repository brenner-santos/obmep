...
class EdObmep2015TeacherSpider(BaseTeacherSpider):
    name = 'obmep2015-teacher'
    start_urls = [
        'https://premiacao.obmep.org.br/2015/verRelatorioProfessoresPremiados.do.htm',
    ]

    def parse(self, response):
        awards = [
            ' '.join(award.css('::text').getall())[9:]
