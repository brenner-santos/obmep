...
class EdObmep2014TeacherSpider(BaseTeacherSpider):
    name = 'obmep2014-teacher'
    start_urls = [
        'https://premiacao.obmep.org.br/2014/verRelatorioProfessoresPremiados.do.htm',
    ]

    def parse(self, response):
        awards = [
            ' '.join(award.css('::text').getall()).split('-')[9:]
    ...
    def extract_schools(self, data):
        ...
        types = self.remove_dash(data[5].css('::text').getall())
